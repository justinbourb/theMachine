...
*2) CSS is all broken now that index.html resource bars being generated by templates.js renderResourceBarHTML()
*  2a) modify CSS rules to be by class - all resource bar elements share the same class across resource types
*3) test.html should also create testContainer.innerHTML from templates.js renderResourceBarHTML()
**/
